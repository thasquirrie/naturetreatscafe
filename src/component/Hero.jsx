    ...
    <div className="relative bg-white">
      ...
      <div className="relative max-w-3xl mx-auto pb-96 px-4 text-center sm:pb-0 sm:px-6 lg:px-8">
        ...
        <div className="relative py-32">
          <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl md:text-6xl">Welcome to <span className='text-yellow-900'>Nature</span> <span className='text-pink-500'>Treats</span> Café</h1>
